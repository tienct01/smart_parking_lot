...
const char* ssid = "P202";         // Tên của mạng WiFi mà bạn muốn kết nối đến
const char* password = "tuhomedia";   // Mật khẩu của mạng WiFi
...
void connectWebSocket() {
  webSocket.begin("192.168.0.104", 3000, "/");          // Địa chỉ websocket server, port và URL
...
void webSocketEvent(WStype_t type, uint8_t * payload, size_t length) {
  ...
  switch (type) {
    ...
    case WStype_CONNECTED:                            // Sự kiện khi client kết nối
      ...
      webSocket.sendTXT("ESP8266 connected");          // Thông báo kết nối thành công
      break;
